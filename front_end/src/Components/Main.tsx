...
export const Main = () => {
    ...
    const networkName = chainId ? (helperConfig as any)[chainId] : "dev"
    let stringChainId = String(chainId)
    const dappTokenAddress = chainId ? (networkMapping as any)[stringChainId]["DappToken"][0] : constants.AddressZero
    const wethTokenAddress = chainId ? (brownieConfig as any)["networks"][networkName]["weth_token"] : constants.AddressZero // brownie config
