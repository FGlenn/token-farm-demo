...
import pytest
from scripts.deploy_tokenfarm import KEPT_BALANCE, deploy_token_farm_and_dapp_token
...
def test_get_user_total_value_with_different_tokens(amount_staked, random_erc20):
    ...
    # INITIAL_VALUE = initial ETH/USD price = 2000 ETH/USD
    # From: def test_stake_tokens(amount_staked): worth of 1 ETH staked
    # From: def test_get_user_total_value_with_different_tokens(amount_staked, random_erc20): worth of 2 ETH staked
    # total value of user = 1+2= worth of 3ETH
