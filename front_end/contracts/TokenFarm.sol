...
contract TokenFarm is Ownable {
    // token address => token holder => amount
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        // By importing and "IERC20(_token)" gets the ABI and allows the contract to interact with tokens.
    ...
    // To see how many different tokens each address has staked.
    ...
    // Only the owner of the contract can add allowed tokens to the allowedTokens array.
    function addAllowedToken(address _token) public onlyOwner {
        allowedTokens.push(_token);
    }

    // This is a for loop to check if the token to be staked is in the allowTokens array.
